...
Um **contêiner** é o espaço dedicado ao seu negócio dentro do Metrito. Todos os seus dados de rastreamento, fontes e destinos ficam organizados dentro dele.

| Propriedade | Descrição |
|-------------|-----------|
| **ID do Contêiner** | Identificador único no formato `MTC-XXXXXXX` |
| **Domínio** | O(s) domínio(s) do site associado ao contêiner |
...
Cada evento, lead e sessão pertence a exatamente um contêiner. Os dados nunca se misturam entre contêineres diferentes.
